...
class ViewController: UIViewController, GADFullScreenContentDelegate {
    ...
    override func viewDidLoad() {   //画面起動時の処理
        ...
        GADInterstitialAd.load(withAdUnitID:"ca-app-pub-2313732454636490/5488553871",
                               request: request,
    ...
    func randomImage(){
        ...
        if imagerandom % 24 <= 5{
            image1.image = UIImage(named: "齊")
            if imagerandom % 24 == 0{
                image2.image = UIImage(named: "齋")
                image3.image = UIImage(named: "斉")
                image4.image = UIImage(named: "斎")
            }
            if imagerandom % 24 == 1{
                image2.image = UIImage(named: "齋")
                image3.image = UIImage(named: "斎")
                image4.image = UIImage(named: "斉")
                
            }
            
            if imagerandom % 24 == 2{
                image2.image = UIImage(named: "斉")
                image3.image = UIImage(named: "齋")
                image4.image = UIImage(named: "斎")
            ...
            if imagerandom % 24 == 3{
                image2.image = UIImage(named: "斉")
                image3.image = UIImage(named: "斎")
                image4.image = UIImage(named: "齋")
                
            }
            
            if imagerandom % 24 == 4{
                image2.image = UIImage(named: "斎")
                image3.image = UIImage(named: "齋")
                image4.image = UIImage(named: "斉")
        ...
        if imagerandom % 24 >= 6 && imagerandom % 24 <= 11{
            image1.image = UIImage(named: "齋")
            if imagerandom % 24 == 6{
                image2.image = UIImage(named: "齊")
                image3.image = UIImage(named: "斉")
                image4.image = UIImage(named: "斎")
            }
            if imagerandom % 24 == 7{
    ...
    @objc func tapCorrect(sender: Any) { //齊を押した時の処理
        counter += 1
        counterLabel.text = "\(counter)/\(practicetime)"
    ...
    @objc func tapUncorrect(sender: Any) {  //齋を押した時の処理
    ...
    @objc func tapI(sender: Any) {  //斉をタップした際の処理
    ...
    @objc func tapDon(sender: Any) {   //斎をタップした際の処理
